 ...
 * @version v1.2.7
 * @filesource @usage $autoload['config'] = array('asset');
...
if (! function_exists('vendor_url')) {
    ...
    function vendor_url()
    {
        ...
        $CI = & get_instance();
        // return the full asset path
        return base_url() . $CI->config->item('vendor_path');
    }
}
 ...
 * @return string
 */
if (! function_exists('extcss')) {

    function extcss($file, $media = 'all')
    {
        return sprintf('<link rel="stylesheet" type="text/css" href="' . asset_url() . 'ext/' . $file . '" media="' . $media . '">' . "\n");
    }
}
if (! function_exists('extuicss')) {

    function extuicss($file, $media = 'all')
    {
        return '<link rel="stylesheet" type="text/css" href="' . asset_url() . 'extui/' . $file . '" media="' . $media . '">' . "\n";
    }
}
/**
 * Load LESS
 ...
 * @return string
 */
if (! function_exists('extless')) {

    function extless($file)
    {
        return '<link rel="stylesheet/less" type="text/css" href="' . asset_url() . 'ext/' . $file . '">' . "\n";
    }
}
/**
 * Load JS
...
if (! function_exists('extjs')) {
    ...
    function extjs($file, $atts = array())
    {
        $element = '<script type="text/javascript" src="' . asset_url() . 'ext/' . $file . '"';
...
if (! function_exists('extuijs')) {

    function extuijs($file, $atts = array())
    {
        $element = '<script type="text/javascript" src="' . asset_url() . 'extui/' . $file . '"';
...
if (! function_exists('vendorjs')) {
    function vendorjs($file, $atts = array())
    {
        $element = '<script type="text/javascript" src="' . vendor_url() . $file . '"';
 ...
 * @return string
 */
if (! function_exists('extimg')) {

    function extimg($file, $atts = array())
    {
        $url = '<img src="' . asset_url() . '/ext/' . $file . '"';
        foreach ($atts as $key => $val)
            $url .= ' ' . $key . '="' . $val . '"';
        $url .= " />\n";
        return $url;
...
if (! function_exists('extuiimg')) {

    function extuiimg($file, $atts = array())
    {
        $url = '<img src="' . asset_url() . '/extui/' . $file . '"';
        foreach ($atts as $key => $val)
            $url .= ' ' . $key . '="' . $val . '"';
        $url .= " />\n";
        return $url;
...
if (! function_exists('extpath')) {

    function extpath($file)
    {
        $url = asset_url() . 'ext/' . $file;
        return $url;
    }
}
if (! function_exists('extuipath')) {

    function extuipath($file)
    {
        $url = asset_url() . 'extui/' . $file;
        return $url;
    }
}
/**
 ...
 * @return string
 */
if (! function_exists('cssapp')) {

    function cssapp($file, $media = 'all')
    {
        return '<link rel="stylesheet" type="text/css" href="' . asset_url() . 'cssapp/' . $file . '" media="' . $media . '">' . "\n";
    }
}
 ...
 * @return string
 */
if (! function_exists('jsapp')) {

    function jsapp($file, $atts = array())
    {
        $element = '<script type="text/javascript" src="' . asset_url() . 'jsapp/' . $file . '"';
...
if (! function_exists('set_element')) {
    ...
    function set_element($data, $key, $value)
    {
        if (!is_array($data)) {
            return $data;
        }
